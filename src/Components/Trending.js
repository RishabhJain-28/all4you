          ...
          <div className="row">
            ...
            <div className="col-sm-4">
              <div
                ...
                style={{ width: "100%", marginTop: 20 }}
              >
                <a href="https://all4you.co.in/details/subway-vashi">
                  <img
                    className="card-img-top"
                    src="./All For U_files/3_2019_09_02_11_35.jpeg"
                    alt="Card image cap"
                  />
                </a>
                <div className="card-body text-center">
                  <a href="https://all4you.co.in/details/subway-vashi"></a>
                  <a href="https://all4you.co.in/details/subway-vashi">
                    <h3 className="hptitle">Subway Vashi</h3>
                  </a>
                  <h4 className="hptitle">Sub of the week</h4>
                  ...
                  <span className="offerprice">
                    <span className="discount">100</span>% Off
                  </span>
                  <span className="offerprice" style={{ color: "purple" }}>
                    <i className="fa fa-inr"> 1</i>
                  </span>
